...
public class TankClient extends Frame {
	...
	Tank Queen = new Tank(900,650,false,Direction.D,this,false,false,true);
	...
	boolean addPtTrack1 = false;
	boolean addPtTrack2 = false;
	boolean addPtTrack3 = false;
	boolean addPtTrack4 = false;
	boolean addKing1 = false;
	boolean addKing2 = false;
	boolean addKing3 = false;
	boolean addKing4 = false;
	boolean addKing5 = false;
	...
	public void paint(Graphics g) {
		...
		/*
			if(Queen.getLife() == 5000) {
				tanks.add(new Tank(30,100,false,Direction.D,this,false,true));
			}
			if(Queen.getLife() == 5000)
		*/
			//升级时tank的初始化
...
//rlb的限制 在eat里
		...
		if(smb.eatenNum == 10&&!addPtTrack1) {
			tanks.add(new Tank(20,80,false,Direction.D,this,true,false));
			addPtTrack1 = true;
		}
		if(imb.eatenNum == 13&&!addPtTrack2) {
			tanks.add(new Tank(920,70,false,Direction.D,this,true,false));
			addPtTrack2 = true;
		}
		if(smb.eatenNum == 15&&!addPtTrack4) {
			tanks.add(new Tank(20,80,false,Direction.D,this,true,false));
			addPtTrack4 = true;
		}
		if(sub.eatenNum == 18&&!addPtTrack3) {
			tanks.add(new Tank(920,170,false,Direction.D,this,true,false));
			addPtTrack3 = true;
		}
		if(sub.eatenNum == 25&&!addKing1) {
			tanks.add(new Tank(20,80,false,Direction.D,this,false,true));
			addKing1 = true;
		}
		if(lmb.eatenNum == 7&&!addKing2) {
			tanks.add(new Tank(920,70,false,Direction.D,this,false,true));
			addKing2 = true;
		}
		if(lmb.eatenNum == 12&&!addKing3) {
			tanks.add(new Tank(920,170,false,Direction.D,this,false,true));
			addKing3 = true;
		}
		if(imb.eatenNum == 20&&!addKing4) {
			tanks.add(new Tank(920,170,false,Direction.D,this,false,true));
			addKing4 = true;
		}
		if(imb.eatenNum == 26&&!addKing5) {
			tanks.add(new Tank(920,170,false,Direction.D,this,false,true));
			addKing5 = true;
		}
	}
	...
	public void launchFrame() {
		...
		*/
		...
		tanks.add(new Tank(900,650,false,Direction.D,this,false,false,true));
