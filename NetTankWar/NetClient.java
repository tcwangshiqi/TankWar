...
/**
 * 代表网络连接的客户端类，帮助实现与server连接，以及packet接收和解析
	...
	private class UDPRecvThread implements Runnable {
		...
		private void parse(DatagramPacket dp) {
			...
			case Msg.BLOOD_NEW_MSG:
				msg = new BloodNewMsg(NetClient.this.tc);
				msg.parse(dis);
				break;
			case Msg.TANK_RELIFE_MSG:
				msg = new TankRelifeMsg(NetClient.this.tc);
				msg.parse(dis);
			case Msg.TANK_LEVEL_UP_MSG:
				msg = new TankLevelUpMsg(NetClient.this.tc);
				msg.parse(dis);
			}
